...
void generate_python_script() {
    ...
    pyfile << "def main():\n";
    pyfile << "    files = [\"result_time_matrix_hash.txt\", \"result_time_matrix_b.txt\", \"result_time_vector_hash.txt\", \"result_time_vector_b.txt\", \"histogram_test_results_height_performance.txt\", \"histogram_test_results_age_performance.txt\"]\n";
...
// 1 наследование idictionary
// 2 сделать вторую реализацию на двойном масиве и сравнить с реализацией на хэш таблице
